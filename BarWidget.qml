...
//
// This clone embeds an iCalendar feed service so the stock calendar
// panel can show event dots and an upcoming list without a second widget.
BarWidget {
  id: root
  ...
  readonly property var calendarService: calendar
